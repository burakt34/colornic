        ...
        <div className='mt-24 h-[80vh] md:min-h-screen w-full font-helvetica'>
            <div className='px-4 md:px-20 mt-[120px] mb-10'>
                ...
                <div className='flex md:w-3/6 justify-between items-center'>
                    ...
                    <Link className='text-xl md:text-2xl underline hover:underline transition-all delay-1000' href="/ByService">By Service</Link>
                </div>
            </div>
            ...
            <div className='px-4 md:px-20'>
                <div className='md:flex gap-10'>
                    <div className='mb-20 md:mb-0'>
                        <img src="work_sevice11.png" alt="" />
                    </div>
                    <div className='mb-20 md:mb-0'>
                        <img src="work_sevice12.png" alt="" />
                    </div>
                    <div className='mb-20 md:mb-0'>
                        <img src="work_sevice13.png" alt="" />
                    </div>
                </div>

                <div className='md:flex gap-10 md:mt-20'>
                    <div>
                        <img src="work_sevice21.png" alt="" />
                    </div>
